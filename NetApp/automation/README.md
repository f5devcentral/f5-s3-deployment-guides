...
roles/
  ...
  bigip_monitor_https/       # custom StorageGRID S3 HTTPS monitor
...
services:
  - name: storagegrid_s3
    ...
    pool:
      ...
      monitor: Options_HTTPS_StorageGRID
      members:
...
- pool: `storageGRID_Pool`
- virtual server: `StorageGRID_S3_Virtual_Server`
...
ansible-playbook playbooks/deploy_service.yml -e service_name=storagegrid_s3
...
ansible-playbook playbooks/teardown_service.yml -e service_name=storagegrid_s3
```
...
- The `Options_HTTPS_StorageGRID` custom HTTPS monitor is created before pools and removed after pool teardown.
...
```
tmsh list ltm virtual StorageGRID_S3_Virtual_Server
tmsh list ltm pool    storageGRID_Pool
tmsh list ltm node
```
